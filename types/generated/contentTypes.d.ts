...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    numberOfTables: Schema.Attribute.Integer &
    ...
    tournaments: Schema.Attribute.Relation<'oneToMany', 'api::tournament.tournament'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    venueType: Schema.Attribute.Enumeration<['club', 'hall', 'arena', 'outdoor', 'other']>;
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::news.news'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    relatedTournaments: Schema.Attribute.Relation<'manyToMany', 'api::tournament.tournament'>;
    slug: Schema.Attribute.UID<'title'>;
...
export interface ApiOrganizerOrganizer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::organizer.organizer'> &
      Schema.Attribute.Private;
...
export interface ApiTournamentTournament extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Events including tournaments, training sessions, meetings, social events, etc.';
    displayName: 'Event';
  ...
  attributes: {
    ageCategories: Schema.Attribute.String;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    endDate: Schema.Attribute.Date;
    eventCapacity: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    isOnlineRegistrationOpen: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    level: Schema.Attribute.Enumeration<['regional', 'state', 'national', 'youth', 'veteran']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tournament.tournament'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Relation<'manyToOne', 'api::location.location'>;
    matchFormat: Schema.Attribute.String;
    maxParticipants: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    organizer: Schema.Attribute.Relation<'manyToOne', 'api::organizer.organizer'>;
    playerCategories: Schema.Attribute.Enumeration<
      ['mens', 'womens', 'youth', 'veteran', 'doubles', 'mixed']
    >;
    ...
    seo: Schema.Attribute.Component<'shared.seo', false>;
    skillLevels: Schema.Attribute.Enumeration<
